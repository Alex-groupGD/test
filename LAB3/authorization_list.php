...
<form action="include/auto.php" method="post">
    <div class="row" style="margin-left: 500px; margin-right: 500px">
        <div class="form-group">
            <label for="exampleInputEmail1">Email</label>
            <input name="email" type="email" class="form-control , col-sm-10" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">

        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Пароль</label>
            <input name="password" type="password" class="form-control ,col-sm-10" id="exampleInputPassword1" placeholder="Password">
        </div>
        <div>
            <button type="submit" class="btn btn-primary">Войти

            </button>
            <small id="emailHelp" class="form-text text-muted">Ещё нет аккаунта?<a href="http://localhost/regist.php"> Зарегистрируйтесь</a></small>
        </div>
    </div>
    <div>
