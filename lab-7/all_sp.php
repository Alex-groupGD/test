...
<button type="button" class="btn btn-outline-primary m-3 " ><a href="http://localhost/add_pos.php"> Добавить позицию</a></button>
...
<table>
    ...
    <?php foreach($positions as $mon): ?>
        <tr>
            ...
            <td>
                <form  action="update_pos.php" method="POST">
                    <button type="submit" class="btn btn-success" name="id" value="<?=htmlspecialchars($mon['id'])?>">Редактировать</button>
                </form>
            </td>
            <td>
                <form  action="delete.php" method="POST">
                    <button type="submit" class="btn btn-danger" name="id" value="<?=htmlspecialchars($mon['id'])?>">Удалить</button>
                </form>
            </td>
        </tr>
    <?php endforeach ?>
